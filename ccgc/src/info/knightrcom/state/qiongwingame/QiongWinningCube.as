package info.knightrcom.state.QiongWingame
{
	...
	public class QiongWinningCube
	{
		 ...
		 * 
		 */
		public function QiongWinningCube(currentTrack:String, parentTrackResult:String = null, rootCube:QiongWinningCube = null, parentCube:QiongWinningCube = null)
		{
		...
		/** 碰节点 */
		private var pongCube:QiongWinningCube;

		/** 将节点 */
		private var eyeCube:QiongWinningCube;

		/** 吃节点 */
		private var chowCube:QiongWinningCube;

		/** 父节点 */
		public var parentCube:QiongWinningCube;

		/** 根节点 */
		private var rootCube:QiongWinningCube;
		...
		public function walkAllRoutes():void {
			...
			var tempRootCube:QiongWinningCube, optrResult:Array = null;
			...
			if (/^(\w+),\1,\1.*$/.test(currentTrack)) {
				...
				this.pongCube = new QiongWinningCube(optrResult[0], optrResult[1], tempRootCube, this);
			...
			if (/^(\w+),\1.*$/.test(currentTrack)) {
				...
				this.currentTrackResult = optrResult[1];
				this.eyeCube = new QiongWinningCube(optrResult[0], optrResult[1], tempRootCube, this);
			...
			if (optrResult != null) {
				this.currentTrackResult = optrResult[1];
				this.chowCube = new QiongWinningCube(optrResult[0], optrResult[1], tempRootCube, this);
		 ...
		 * 
		 */
		private function addWinRoute(leafCube:QiongWinningCube):void {
			// 构造完整的牌型
