package info.knightrcom
{
	...
	public class UIManager
	{
		...
		{
        	HttpServiceProxy.send(LocalAdminLoginService.LOGIN_ADMIN_SERVER,
        		{USERNAME : adminApp.txtUsername.text, PASSWORD : adminApp.txtPassword.text}, 
        		null, 
		...
		public static function itemClickHandler(event:ListEvent):void {
            ...
            switch (label) {
            	...
            	case "启动游戏服务器":
            		...
            		break;
            	case "关闭游戏服务器":
	            	HttpServiceProxy.send(LocalApplicationServerOperationService.STOP_APPLICATION_SERVER,
	            		null, null, 
	            		function ():void {
            		...
            		break;
            	case "重新启动游戏服务器":
	            	HttpServiceProxy.send(LocalApplicationServerOperationService.RESTART_APPLICATION_SERVER,
	            		null, null, 
	            		function ():void {
